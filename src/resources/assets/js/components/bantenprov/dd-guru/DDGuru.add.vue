...
export default {
    ...
    methods: {
              ...
              if(this.model.tahun >= 2000 && this.model.tahun <= (new Date()).getFullYear())
              {
                ...
                .then(response => {
                  if(response.data.type == 'success'){
                    ...
                    window.location.href = '#/admin/dd-guru/'+response.data.id
                  }
                  else{
                    miniToastr.error(response.data.message, response.data.title)
                    window.location.href = '#/admin/dd-guru/create'
                  }
                },
                window.location.href = '#/admin/dd-guru/create')
        ...
        back() {
            window.location = '#/admin/dd-guru';
        }
    },
    mounted: function() {
        axios.get("/dd-guru/create").then(response => {
